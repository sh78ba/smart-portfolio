    ...
    <div className="px-2 pt-2">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {currentNews.map((n, idx) => (
          <div
            key={idx}
            className="max-w-sm w-full mx-auto p-6 bg-gray-50 border border-gray-200 rounded-lg shadow-sm hover:scale-105 hover:shadow-blue-400 hover:shadow-md transition duration-500 ease-in-out"
          >
      ...
      {/* Pagination Controls */}
      {totalPages > 1 && (
        <div className="my-7 flex justify-center gap-4 items-center ">
          <button
            onClick={goToPrevious}
            disabled={currentPage === 1}
            className="px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 disabled:opacity-50 cursor-pointer"
          >
            Previous
          </button>
